...
var files = (function () {
  ...
  Singleton.defaultOptions = {
	...
	"about_me.txt": "'Career' might be a generous term. Let's call it a sustained endeavor in effort-avoidance. It all began in high school chemistry with those dreaded titration curves. Chemistry was torturous enough, but manually plotting these curves point by point? Pure madness. Being naturally predisposed to efficiency (read: laziness), I sought refuge in Excel. Suddenly, curves materialized with clinical precision. Then came an unexpected plot twist: validation. Teachers oscillated between impressed and disturbed – probably sensing the AI apocalypse lurking around the corner – while classmates simply wanted to outsource their work to me. That first hit of recognition for automated shortcuts was intoxicating. A questionable detour through sociology later (we'll save that story for never), I found myself back where I started: optimizing processes for fellow efficiency seekers. Now I help people achieve maximum output with minimum input – a professional enabler of strategic laziness, if you will. And to think it all started because I couldn't be bothered to draw a few lines in chemistry class.\n\n**Important Disclaimer:** This website was meant to be a portfolio, but I got distracted tinkering with this terminal. So, no portfolio here! Think of it as a testament to my love for cool interfaces over actual work. If you need proof of my skills, maybe ask about my arcade high scores instead. At least the terminal is fun, right?",
