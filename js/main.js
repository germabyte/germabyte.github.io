...
var files = (function () {
  ...
  Singleton.defaultOptions = {
	...
	"about_me.txt": "So, 'career' is probably overselling it. More like a long-term project of avoiding actual effort. It started in high school chemistry. Titration curves. Ugh. Not the chemistry itself, but the drawing them by hand part. That felt like unnecessary work, even for high school. Being naturally inclined to minimize effort, I looked for a shortcut. Excel, surprisingly, could do it. Suddenly, curves appeared. And then… people were actually impressed? Teachers, a little. Classmates, mostly just wanted me to do theirs too. Still, that little bit of positive feedback was… unexpected. Turns out, even I'm not immune to a bit of praise for being efficient, even if it started from pure laziness. So I kept automating other lab stuff. Then there was a whole detour with a sociology degree - don't even get me started, total tangent. But eventually, it all circled back. Now I'm here, making life easier for folks who appreciate a good shortcut as much as I do. Basically, I help people be efficiently lazy. It's a dream job, you must agree. And to think, it all started because I was too lazy to draw some dumb lines in chemistry.",
